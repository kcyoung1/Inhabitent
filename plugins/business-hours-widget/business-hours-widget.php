 ...
 * @author    Kurtis Young <kcyoung1@ualberta.ca>
 * @license   GPL-2.0+
 * @link      http://inhabitent.dev
 * @copyright 2015 Inhabitent Supply Co.
 *
 * @wordpress-plugin
 * Plugin Name:       Inhabitent Business Hours
 * Plugin URI:        http://inhabitent.dev
 * Description:       A handy business hours widget for the Inhabitent website
 * Version:           1.0.0
 * Author:            Kurtis Young
...
class Inhabitent_Hours extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'description' => 'The business hours of the company.'
			)
		);
	...
	public function widget( $args, $instance ) {
		...
		$saturday = empty( $instance['saturday'] ) ? '' : apply_filters( 'widget_sat', $instance['saturday'] );
		$sunday = empty( $instance['sunday'] ) ? '' : apply_filters( 'widget_sun', $instance['sunday'] );
